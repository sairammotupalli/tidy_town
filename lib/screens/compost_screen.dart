  ...
  final List<Map<String, dynamic>> compostableItems = [
    {
      ...
      'isCompostable': true,
      'story': "Wheee! I'm a banana peel and I love joining my veggie and fruit friends in the compost pot! Together, we turn into super soil that helps new plants grow. Composting is our happy dance for the Earth! 🍌🥕🍏🌱",
    },
    {
      'name': 'Coffee Grounds',
      'image': 'assets/images/compost/CompostLearning2.png',
      'isCompostable': true,
      'story': "Hey there! I'm coffee grounds, and I'm not just for making you energetic! I'm full of nitrogen that makes worms dance with joy!",
    },
    {
      'name': 'Eggshells',
      'image': 'assets/images/compost/CompostLearning3.png',
      'isCompostable': true,
      'story': "Crack! I'm an eggshell, and I'm not just a breakfast leftover! I add calcium to the soil, making plants grow as strong as superheroes! 💪🌿",
    },
    {
      'name': 'Yard Trimmings',
      'image': 'assets/images/compost/CompostLearning4.png',
      'isCompostable': true,
      'story': "Yo! I'm yard trimmings, and I'm not just garden waste! I'm like a cozy blanket for worms and a buffet for helpful bacteria! 🐛🍽️",
    },
    {
      'name': 'Plastic Bags',
      'image': 'assets/images/compost/CompostLearning5.png',
      'isCompostable': false,
      'story': "Oops! I'm a plastic bag, and I'm not compostable! I'm like a party crasher at the compost party - I just don't belong here! 🚫🎉",
    },
    {
      'name': 'Meat and Dairy',
      'image': 'assets/images/compost/CompostLearning6.png',
      'isCompostable': false,
      'story': "Hey! I'm meat and dairy, and I'm not compostable! I'm like a stinky guest that nobody wants at the compost party! 🚫",
    },
  ];
                ...
                ValueListenableBuilder<int>(
                  ...
                  builder: (context, currentPage, _) {
                    return Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: List.generate(compostableItems.length, (index) {
                          return Container(
                            width: 12,
                            height: 12,
                    ...
                    builder: (context, currentPage, _) {
                      return Row(
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(
                            onPressed: currentPage < compostableItems.length - 1
                                ? () {
