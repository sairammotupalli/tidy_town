...
class TranslationService {
  ...
  final Map<String, String> _translations = {
    ...
    "Hey Western! Are you sure you want to logout?":
        "¡Hola Western! ¿Estás seguro de que quieres cerrar sesión?",
    ...
    "Learn about recycling in a fun way! 🌟":
        "¡Aprende sobre el reciclaje de una manera divertida! 🌟",
    ...
    // Item descriptions
    "Flatten cardboard boxes and keep paper clean and dry":
        "Aplana las cajas de cartón y mantén el papel limpio y seco",
    "Rinse bottles and remove caps before recycling":
        "Enjuaga las botellas y quita las tapas antes de reciclar",
    "Clean and empty glass bottles and jars":
        "Limpia y vacía botellas y frascos de vidrio",
    "Rinse cans and crush if possible to save space":
        "Enjuaga las latas y aplástalas si es posible para ahorrar espacio",
    "All fruit and vegetable waste can be composted":
        "Todos los residuos de frutas y verduras se pueden compostar",
    "Coffee grounds and filters are great for composting":
        "El café molido y los filtros son excelentes para el compostaje",
    "Grass clippings, leaves, and small twigs":
        "Recortes de césped, hojas y ramitas pequeñas",
    "Crushed eggshells add calcium to your compost":
        "Las cáscaras de huevo trituradas agregan calcio a tu compost",
    "Broken plates, cups, and other ceramics cannot be recycled":
        "Los platos, tazas y otras cerámicas rotas no se pueden reciclar",
    "Used tissues and paper towels are not recyclable":
        "Los pañuelos y toallas de papel usados no son reciclables",
    "Most places cannot recycle styrofoam packaging":
        "La mayoría de los lugares no pueden reciclar el empaque de poliestireno",
    "Regular plastic bags cannot be recycled in normal bins":
        "Las bolsas de plástico normales no se pueden reciclar en contenedores normales",
    ...
    "Wally the Water Bottle's Second Chance":
        "La Segunda Oportunidad de Wally la Botella de Agua",
    "Rocky the Robot's Recycling Adventure":
        "La Aventura de Reciclaje del Robot Rocky",
    ...
    "Choose a story to learn why recycling is important!":
        "¡Elige una historia para aprender por qué es importante reciclar!",
    ...
    "Select a theme for your waste sorting adventure!":
        "¡Selecciona un tema para tu aventura de clasificación de residuos!",
    "Waste Sorting Game": "Juego de Clasificación de Residuos",
    "Learn to sort waste into the right bins!":
        "¡Aprende a clasificar los residuos en los contenedores correctos!",
    "Village Adventure": "Aventura en la Aldea",
    "Help Farmer Sam keep the peaceful village clean!":
        "¡Ayuda al Granjero Sam a mantener limpia la aldea pacífica!",
    "Town Explorer": "Explorador de la Ciudad",
    "Help Maya sort waste in the busy town center!":
        "¡Ayuda a Maya a clasificar los residuos en el centro de la ciudad!",
    "Space Mission": "Misión Espacial",
    "Help Captain Luna clean up space debris!":
        "¡Ayuda a la Capitana Luna a limpiar los desechos espaciales!",
    "Beach Cleanup with Alex": "Limpieza de Playa con Alex",
    "Help Ocean Alex save marine life and discover beach waste!":
        "¡Ayuda a Alex del Océano a salvar la vida marina y descubrir los residuos de la playa!",
    "Home Cleanup with Bella": "Limpieza del Hogar con Bella",
    "Help Bella sort waste in the kitchen, bathroom, and living room!":
        "¡Ayuda a Bella a clasificar residuos en la cocina, el baño y la sala!",

    // === HOUSE GAME ===
    "Kitchen Cleanup": "Limpieza de la Cocina",
    "Bathroom Cleanup": "Limpieza del Baño",
    "Living Room Cleanup": "Limpieza de la Sala",
    "Kitchen time! Drag each item into the right bin.":
        "¡Hora de la cocina! Arrastra cada objeto al contenedor correcto.",
    "Bathroom time! Be careful and sort each item properly.":
        "¡Hora del baño! Ten cuidado y clasifica cada objeto correctamente.",
    "Last stop! Sort the living room waste.":
        "¡Última parada! Clasifica los residuos de la sala.",
    "Hi! I'm Bella! 👋\nToday is cleaning day at my house!\n\nWill you help me sort the waste we find in each room?":
        "¡Hola! Soy Bella 👋\n¡Hoy es día de limpieza en mi casa!\n\n¿Me ayudas a clasificar los residuos que encontremos en cada cuarto?",
    "Let's start in the kitchen — that's where most of the waste comes from!":
        "¡Empecemos en la cocina — de ahí viene la mayor parte de los residuos!",
    "Oh no, look at all this!\nLet's sort it properly.":
        "¡Oh no, mira todo esto!\nVamos a clasificarlo correctamente.",
    "Now to the bathroom! Even here we need to be careful about what goes where.":
        "¡Ahora al baño! Incluso aquí debemos tener cuidado con lo que va en cada lugar.",
    "Last stop — the living room! Almost done!":
        "Última parada — ¡la sala! ¡Ya casi terminamos!",
    "Amazing! The whole house is clean!\nYou're a waste sorting superstar!":
        "¡Increíble! ¡Toda la casa está limpia!\n¡Eres una superestrella clasificando residuos!",
    "Amazing! The whole house is clean! You're a waste sorting superstar!":
        "¡Increíble! ¡Toda la casa está limpia! ¡Eres una superestrella clasificando residuos!",
    "🏠 House Cleaned!": "🏠 ¡Casa Limpia!",
    "Vegetable Peels": "Cáscaras de Verduras",
    "Plastic Juice Bottle": "Botella de Jugo de Plástico",
    "Leftover Food": "Sobras de Comida",
    "Chips Packet": "Bolsa de Papas",
    "Empty Shampoo Bottle": "Botella de Champú Vacía",
    "Cotton Balls": "Bolas de Algodón",
    "Expired Medicine": "Medicina Vencida",
    "Cardboard Toilet Roll": "Rollo de Cartón del Baño",
    "Old Newspaper": "Periódico Viejo",
    "Broken Plastic Toy": "Juguete de Plástico Roto",
    "Glass Picture Frame": "Marco de Foto de Vidrio",
    "Vegetable peels can break down and become healthy compost.":
        "Las cáscaras de verduras se pueden descomponer y convertirse en composta saludable.",
    "An empty plastic juice bottle can be recycled into something new.":
        "Una botella de jugo de plástico vacía puede reciclarse y convertirse en algo nuevo.",
    "Leftover food can go to compost instead of the trash.":
        "Las sobras de comida pueden ir al compost en lugar de la basura.",
    "Chips packets are mixed materials, so they go to landfill.":
        "Las bolsas de papas tienen materiales mezclados, así que van al vertedero.",
    "An empty shampoo bottle can be rinsed and recycled.":
        "Una botella de champú vacía se puede enjuagar y reciclar.",
    "Used cotton balls belong in landfill.":
        "Las bolas de algodón usadas van al vertedero.",
    "Expired medicine is hazardous and needs safe disposal.":
        "La medicina vencida es peligrosa y necesita una eliminación segura.",
    "A cardboard toilet roll can be recycled.":
        "Un rollo de cartón del baño se puede reciclar.",
    "Old newspaper can become new paper when recycled.":
        "El periódico viejo puede convertirse en papel nuevo cuando se recicla.",
    "Broken plastic toys are usually mixed materials, so they go to landfill.":
        "Los juguetes de plástico rotos suelen tener materiales mezclados, así que van al vertedero.",
    "Broken picture-frame glass should go to landfill for safety.":
        "El vidrio roto de un marco de foto debe ir al vertedero por seguridad.",
    "Candy wrappers are not recyclable in regular bins.":
        "Las envolturas de dulces no se reciclan en contenedores normales.",

    // Beach Game - General UI
    "Score: ": "Puntuación: ",
    "🏖️ Beach Cleanup Complete!": "🏖️ ¡Limpieza de Playa Completa!",
    "Amazing! You helped Alex clean up the beach!":
        "¡Increíble! ¡Ayudaste a Alex a limpiar la playa!",
    ...
    "Hurray right! That's exactly where it belongs!":
        "¡Hurra correcto! ¡Exactamente donde pertenece!",
    "Sorry it is wrong! But don't worry, let's try the next one!":
        "¡Lo siento, está mal! Pero no te preocupes, ¡probemos con el siguiente!",
    ...
    "I am a Plastic Bag! where do i go?":
        "¡Soy una Bolsa de Plástico! ¿a dónde voy?",
    ...
    "To reuse materials and save resources":
        "Para reutilizar materiales y ahorrar recursos",
    ...
    "You've successfully sorted all the waste items!":
        "¡Has clasificado exitosamente todos los residuos!",
    ...
    "Learn about composting in a fun way! 🌟":
        "¡Aprende sobre el compostaje de manera divertida! 🌟",
    ...
    "Choose a story to learn why composting is important!":
        "¡Elige una historia para aprender por qué el compostaje es importante!",
    ...
    "Magic soil? Really?": "¿Tierra mágica? ¿De verdad?",
